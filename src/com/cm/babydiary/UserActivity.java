...
public class UserActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		usernameEdit = (EditText) findViewById(R.id.login_et);
		passwordEdit = (EditText) findViewById(R.id.user_pw);
		signInButton = (Button) findViewById(R.id.sign_in);
		signUpButton = (Button) findViewById(R.id.sign_up);
		todoListActivityIntent = new Intent(this, MilestoneActivity.class);
		...
		paUser.signUpInBackground(new SignUpCallback() {
			...
			public void done(ParseException e) {
				...
				if (e == null) {
					...
					perror( parseErrResolver.resolve(UserActivity.this, e) );
				}
			}
		});
	}
